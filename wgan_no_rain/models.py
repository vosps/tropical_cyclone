...
def discriminator(arch,
    ...
    # new step: upscale number values to 10 x 10 for concatenation!
    block_channels = [filters_disc, 2*filters_disc]
    # block_channels = [1, 2]
    lo_res_input = UpSampling2D(size=(5, 5), interpolation='bilinear')(generator_input)
    ...
    print(lo_res_input.shape)
    print(hi_res_input.shape)
