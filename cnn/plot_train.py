...
# load in data
X_filepath = 'data/X_new.npy'
ypred_filepath = 'data/y_pred_new.npy'
ytrue_filepath = 'data/y_true_new.npy'
...
y_lat2d, y_lon2d = np.linspace(-50, 50, 10),np.linspace(0, 100, 10)
...
axs[0,4] = plot_tc(X[12],lat_2d,lon_2d,axs[0,4])
axs[0,5] = plot_tc(X[13],lat_2d,lon_2d,axs[0,5])
...
axs[2,4] = plot_tc(y_pred[12],lat_2d,lon_2d,axs[2,4])
axs[2,5] = plot_tc(y_pred[13],lat_2d,lon_2d,axs[2,5])
...
axs[1,4] = plot_tc(y_true[12],lat_2d,lon_2d,axs[1,4])
axs[1,5] = plot_tc(y_true[13],lat_2d,lon_2d,axs[1,5])
...
plt.savefig('predictions_100_epochs.png',dpi=600,bbox_inches='tight')
plt.clf()
