...
def create_dataset(year,clss,era_shape=(10,10,1),out_shape=(100,100,1),
    ...
    x = np.float32(np.expand_dims(np.load('/user/work/al18709/tc_data_flipped/train_combined_X.npy')[:,:,:,0],axis=3)) # inputs are (nimags,10,10,nfeatures)
    y = np.float32(np.load('/user/work/al18709/tc_data_flipped/train_combined_y.npy'))
    z = np.float32(np.load('/user/home/al18709/work/tc_data_flipped_t/train_y.npy')) # this is the topography variable (nimages,100,100)
