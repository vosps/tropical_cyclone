...
def setup_batch_gen(train_years,
    ...
    train = None if train_years is None \
                           ...
                           downsample=downsample, weights=weights) #TODO: fix problem here
    ...
    if val_size is not None:
        if val_size <= batch_size:
            ...
            val = tfrecords_generator_ifs.create_fixed_dataset(val_years, batch_size=val_size, downsample=downsample) #TODO: allocate correct validation files here
            val = val.take(1)
        else:
...
def setup_full_image_dataset(years,
    ...
    data_full = DataGeneratorFull(dates=dates, # TODO: look at this function and see if you can insert TC data here
...
def setup_data(train_years=None,
    ...
    if load_full_image is True:
        ...
        batch_gen_train, batch_gen_valid = setup_batch_gen(
            ...
            val_size=val_size,
            downsample=downsample,
            weights=weights) #TODO: fix issue here!
