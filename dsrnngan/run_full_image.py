...
if mode == "ensemble":
    log_path = "/ppdata/lucy-cGAN/logs/no_constants/IFS"
    rank_samples = 100
else:
    raise NotImplementedError("No deterministic version of VAE-GAN")
...
if add_noise == False and load_full_image==False:
    out_fn_q = "{}/qual-{}_no_noise__{}.txt".format(log_path, application, str(val_years))
elif add_noise ==True and load_full_image==False:
    out_fn_q = "{}/qual-{}_noise__{}.txt".format(log_path, application, str(val_years))
if add_noise == False and load_full_image==True:
    out_fn_q = "{}/qual-{}_no_noise_full_image__{}.txt".format(log_path, application, str(val_years))
elif add_noise ==True and load_full_image==True:
    out_fn_q = "{}/qual-{}_noise_full_image__{}.txt".format(log_path, application, str(val_years))
