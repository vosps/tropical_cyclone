...
out_fn = "{}/dataset-test-{}-{}_val_size_1600_5.txt".format(log_path, application, N_range[0])                                                                                                               
weights_dir = log_path


eval.rank_metrics_by_time(mode, train_years, val_years, application, out_fn, weights_dir, check_every=1, 
                          N_range=N_range, batch_size=batch_size, num_batches=num_batches, 
