		...
		with tqdm(total=n_train, desc=f'Epoch {epoch + 1}/{epochs}', unit='img') as pbar:
			for batch in train_loader:
				...
				with torch.cuda.amp.autocast(enabled=amp):
					...
					X = images[:,0,:,:].cpu()
					np.save('data/y_pred_new.npy',y_pred)
					np.save('data/y_true_new.npy',y_true)
					np.save('data/X_new.npy',X)
...
if __name__ == '__main__':
	...
	try:
		train_net(net=net,
				  ...
				  amp=args.amp)
		torch.save(net.state_dict(), '/user/home/al18709/work/cnn/unet_2.pth')
