...
def load_tc_data(set = 'validation',results = 'final'):
	...
	if results == 'final':
	...
	elif results == 'combined':
		# load data
		real = np.load('/user/home/al18709/work/gan_predictions_20/%s_real-opt_combined_test_run_1.npy' % set)
		inputs = np.load('/user/home/al18709/work/gan_predictions_20/%s_input-opt_combined_test_run_1.npy' % set)[:,:,:,0]
		pred_gan = np.load('/user/home/al18709/work/gan_predictions_20/%s_pred-opt_5_normal_problem.npy' % set)[:,:,:,0]
		pred_gan_combined = np.load('/user/home/al18709/work/gan_predictions_20/%s_pred-opt_combined_test_run_1.npy' % set)[:,:,:,0]
		pred_gan_ensemble = np.load('/user/home/al18709/work/gan_predictions_20/%s_pred-opt_5_normal_problem.npy' % set)
		pred_gan_ensemble_combined = np.load('/user/home/al18709/work/gan_predictions_20/%s_pred-opt_combined_test_run_1.npy' % set)
		...
		return real,inputs,pred_gan,pred_gan_combined,pred_gan_ensemble,pred_gan_ensemble_combined,meta,meta_combined
